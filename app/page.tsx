...
const projects = [
  {
    ...
    description: 'A modern resume website built with Next.js 15, featuring responsive design and PDF generation capabilities.',
  ...
  },
  {
    ...
    description: 'Developed a comprehensive project management system with real-time collaboration features.',
    technologies: ['React', 'Node.js', 'WebSocket', 'Database'],
    period: '2024'
  }
]
...
export default function ResumePage() {
  ...
  const downloadPDF = useCallback(() => {
    ...
    link.href = '/resume/Resume.pdf'  // 指向静态PDF文件
    ...
    <section className="sm:px-14 sm:pt-6" id="resume-content">
      ...
      <header className="mb-12">
        <div className="flex flex-col sm:flex-row items-start gap-6">
          <div className="h-14 w-14 rounded-full border border-neutral-200 dark:border-neutral-700 flex-shrink-0 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900 flex items-center justify-center">
